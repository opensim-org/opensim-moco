...
\begin{center}
    ...
    $ y(t) $     & $ (q(t),u(t),z(t)) $                                 & $ f_{\textrm{bias}} $ & centripetal and coriolis forces         & $ V_k $                      & the $k$-th boundary constraint \\
    $ x(t) $     & controls                                             & $ G $                 & kinematic constraint Jacobian           & $ K $                        & number of boundary constraints \\
    $ p    $     & constant parameters                                  & $ f_{\textrm{app}} $  & applied forces                          & $ (\enspace)_{U}   $     & an upper bound \\
    $ \lambda $  & kinematic constraint multipliers                     & $ f_{\textrm{aux}} $  & auxiliary dynamics (explicit \& implicit) & $ (\enspace)_{L}   $     & a lower bound \\
\end{tabular}
\end{center}
