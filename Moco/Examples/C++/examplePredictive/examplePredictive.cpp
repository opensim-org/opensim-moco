...
// Hip left
auto* hipAct_l = new ActivationCoordinateActuator();
hipAct_l->setCoordinate(&hip_l->updCoordinate());
hipAct_l->setName("hipAct_l");
hipAct_l->setOptimalForce(150);
hipAct_l->setMinControl(-1);
hipAct_l->setMaxControl(1);
hipAct_l->set_default_activation(0.1);
