/* -------------------------------------------------------------------------- *
 *              OpenSim:  Bhargava2004MuscleSmoothMetabolicsProbe.cpp         *
 * -------------------------------------------------------------------------- *
 ...
 * Default constructor.
 */
Bhargava2004MuscleSmoothMetabolicsProbe::Bhargava2004MuscleSmoothMetabolicsProbe() : Probe()
{
    setNull();
    constructProperties();
}
 ...
 */
Bhargava2004MuscleSmoothMetabolicsProbe::Bhargava2004MuscleSmoothMetabolicsProbe(
...
//_____________________________________________________________________________
/**
 * Set the data members of this Bhargava2004MuscleSmoothMetabolicsProbe to their null values.
 */
void Bhargava2004MuscleSmoothMetabolicsProbe::setNull()
{
    setAuthors("Tim Dorn");
 ...
 */
void Bhargava2004MuscleSmoothMetabolicsProbe::constructProperties()
{
    ...
    constructProperty_Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameterSet
 ...
 *
 * @param aModel OpenSim model containing this Bhargava2004MuscleSmoothMetabolicsProbe.
 */
void Bhargava2004MuscleSmoothMetabolicsProbe::extendConnectToModel(Model& aModel)
{
    Super::extendConnectToModel(aModel);
    if (!isEnabled()) return;   // Nothing to connect

    const int nM =
        get_Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameterSet()
        .getSize();
    for (int i=0; i<nM; ++i) {
        connectIndividualMetabolicMuscle(aModel,
            upd_Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameterSet()[i]);
    }
}
 ...
 *
 */
void Bhargava2004MuscleSmoothMetabolicsProbe::connectIndividualMetabolicMuscle(
    Model& aModel,
    Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameter& mm)
{
    ...
    if( k < 0 ) {
        cout << "WARNING: Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameter: "
 ...
 */
SimTK::Vector Bhargava2004MuscleSmoothMetabolicsProbe::
computeProbeInputs(const State& s) const
{
    ...
    for (int i=0; i<nM; i++)
    {
        ...
        Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameter& mm =
            get_Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameterSet()[i];
        ...
        if (get_forbid_negative_total_power() || get_shortening_rate_on())
        {
            ...
            {
                // TODO unsmooth but not used if get_use_force_dependent_shortening_prop_constant is true
                if (fiber_velocity <= 0)    // concentric contraction, Vm<0
        ...
        if (get_forbid_negative_total_power() || get_mechanical_work_rate_on())
        {
            ...
            if (get_include_negative_mechanical_work())
                ...
                Wdot = -fiber_force_active*fiber_velocity_conc;
        }
 ...
 * contribution.
 */
int Bhargava2004MuscleSmoothMetabolicsProbe::getNumProbeInputs() const
{
    if (get_report_total_metabolics_only())
        return 1;
    else
 ...
 * contribution.
 */
Array<string> Bhargava2004MuscleSmoothMetabolicsProbe::getProbeOutputLabels() const
{
    Array<string> labels;
    ...
    for (int i=0; i<getNumMetabolicMuscles(); ++i)
        labels.append(getName()+"_"+get_Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameterSet()[i].getName());
...
*/
const int Bhargava2004MuscleSmoothMetabolicsProbe::
    getNumMetabolicMuscles() const
{
    return get_Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameterSet()
        .getSize();
}
 ...
 * metabolic analysis.
 */
void Bhargava2004MuscleSmoothMetabolicsProbe::
...
{
    Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameter* mm =
        new Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameter(
            muscleName,
    ...
    upd_Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameterSet()
 ...
 */
bool Bhargava2004MuscleSmoothMetabolicsProbe::
 ...
 */
const double Bhargava2004MuscleSmoothMetabolicsProbe::
...
const Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameter*
    Bhargava2004MuscleSmoothMetabolicsProbe::getMetabolicParameters(
...
Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameter*
    Bhargava2004MuscleSmoothMetabolicsProbe::updMetabolicParameters(
...
// Set muscle mass
//--------------------------------------------------------------------------
void Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameter::
setMuscleMass()
{
...
// Object interface
//--------------------------------------------------------------------------
void Bhargava2004MuscleSmoothMetabolicsProbe_MetabolicMuscleParameter::setNull()
{
    setAuthors("Tim Dorn");
