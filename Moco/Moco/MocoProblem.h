...
///   - Actuator%s with multiple controls (non-ScalarActuator%s).
    ...
    public:
        ...
        /// using a regular expression. A control variable set with a regular expression will be overriden by a control
        /// variable set explicitly. If a control variable is referenced by two regular expressions, the later one
        /// receives precedence.
        void setStateInfoPattern(const std::string &pattern, const MocoBounds &bounds,
                                 const MocoInitialBounds &init = {},
                                 const MocoFinalBounds &final = {});

        /// Set information about a single control variable in this phase using a regular expression.
        void setControlInfoPattern(const std::string &name, const MocoBounds &,
        ...
        void setControlInfo(const std::string &pattern, const MocoBounds &,
                            const MocoInitialBounds & = {}, const MocoFinalBounds & = {});
        ...
        /// phase.
        void setKinematicConstraintBounds(const MocoBounds &bounds) { set_kinematic_constraint_bounds(bounds); }
        ...
        void setMultiplierBounds(const MocoBounds &bounds) { set_multiplier_bounds(bounds); }
