...
private:
    OpenSim_DECLARE_LIST_PROPERTY(bounds, MocoBounds, "(Optional) The bounds " 
...
protected:
    OpenSim_DECLARE_UNNAMED_PROPERTY(MocoConstraintInfo, "The bounds and "
